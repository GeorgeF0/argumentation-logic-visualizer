...
Argumentation Logic is still new, but many lessons could be learned by undertaking this project and studying the concept of Argumentation Logic. Among what has been learned is how this new type of logic bridges the gap between traditional propositional logic and argumentation theory, and establishes a connection and an analogy between the two.

Argumentation Logic shows how proofs can be seen as exchanges of relevant arguments, by establishing a check that enforces relevance. Subsequently, finding a way to visualize proofs by defining a mapping that allows to convert a natural deduction proof to an argument and vice versa was another interesting lesson.

Argumentation Logic can be extended further to function with more flexible versions of natural deduction that can include substitution and potentially many more shortcuts and derived rules or connectives.

Finally, it can be inferred that an implementation of a particular concept is a great way to help in discovering ideas and probing the concept at hand, leading to more improvements and extensions and a much better understanding of what it involves.
